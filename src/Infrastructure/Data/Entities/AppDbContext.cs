...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Comprobante>(entity =>
        {
            ...
            entity.Property(e => e.IdComprobante).UseIdentityByDefaultColumn();
        });
        ...
        modelBuilder.Entity<NovedadesProveedor>().Property(n => n.Estado).HasConversion<string>();

        modelBuilder
            .Entity<ProductoProveedor>()
        ...
        modelBuilder.Entity<UsuarioPermiso>(entity =>
        {
            ...
            entity.HasKey(up => new { up.IdPermiso, up.IdUsuario }).HasName("usuario_permiso_pkey");
        ...
        modelBuilder.Entity<CondicionDePago>(entity =>
        {
            ...
            entity.Property(e => e.IdCondicionPago).UseIdentityByDefaultColumn();
        });
        ...
        modelBuilder.Entity<Domicilio>(entity =>
        {
            ...
            entity.Property(e => e.Calle).IsRequired().HasMaxLength(100);

            entity
                .HasOne(d => d.IdProvinciaNavigation)
        ...
        modelBuilder.Entity<Proveedor>(entity =>
        {
            ...
            entity
                .HasOne(d => d.IdCondicionPagoHabitualNavigation)
                .WithMany()
            ...
            entity
                .HasOne(d => d.IdDomicilioNavigation)
    ...
    {
        var entradasModificadas = ChangeTracker
            .Entries()
            .Where(e =>
                (e.Entity is Compra || e.Entity is DetalleCompra) && e.State == EntityState.Modified
            )
            .ToList();
        ...
        foreach (var entrada in entradasModificadas)
        {
            ...
            if (!string.IsNullOrEmpty(logCambios))
            {
                var auditoria = new CompraAuditoria
                {
                    ...
                    Motivo =
                        (entrada.Entity is Compra comp)
                            ? (comp.Observaciones ?? "sin observaciones")
                            : "Cambio en ítem de la orden",
                    Detalles = logCambios,
                };
