...
public static partial class DominioMapper
{
    ...
    [MapperIgnoreTarget(nameof(EF.DetalleFactura.IdFactura))]
    // [MapperIgnoreTarget(nameof(EF.DetalleFactura.IdProducto))]
    [MapperIgnoreTarget(nameof(EF.DetalleFactura.PrecioBruto))]
    [MapperIgnoreTarget(nameof(EF.DetalleFactura.PorcentajeDescuento))]
    ...
    [MapProperty(nameof(Dom.DetalleFactura.Producto.IdProducto), nameof(EF.DetalleFactura.IdProducto))]
    [MapperIgnoreSource(nameof(Dom.DetalleFactura.Subtotal))]
    [MapperIgnoreTarget(nameof(EF.DetalleFactura.Producto))]
