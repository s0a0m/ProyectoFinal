...
public static partial class DominioMapper
{
    ...
    [MapProperty(
        nameof(EF.ProductoProveedor.IdProveedor),
        nameof(Dom.ProductoProveedor.Proveedor.IdProveedor)
    )]
    public static partial Dom.ProductoProveedor Map(EF.ProductoProveedor source);

    public static partial IEnumerable<Dom.ProductoProveedor> Map(
        IEnumerable<EF.ProductoProveedor> source
    );

    [MapProperty(
        nameof(Dom.ProductoProveedor.Producto.IdProducto),
        nameof(EF.ProductoProveedor.IdProducto)
    )]
    [MapProperty(
        nameof(Dom.ProductoProveedor.Proveedor.IdProveedor),
        nameof(EF.ProductoProveedor.IdProveedor)
    ...
    public static partial IEnumerable<EF.ProductoProveedor> Map(
        IEnumerable<Dom.ProductoProveedor> source
    );

    // datarow del excel a EF

    // [MapProperty(
    //     nameof(Contracts.ProductoProveedorDataRow.StockActual),
    //     nameof(Dom.ProductoProveedor.StockAsignado)
    // )]
    [MapperIgnoreTarget(nameof(Dom.ProductoProveedor.Producto))]
